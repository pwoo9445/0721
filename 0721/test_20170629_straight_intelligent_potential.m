...
%                 i_est = i_est + 1;
%                 othercars_est  = update_othercars_intelligent_potential(mycar_est, othercars_est, sim, track, car_nr);
%                 [mycar_est, U_ot] = update_control_mycar_est(mycar_est, sim, othercars_est,laneChangePathTranslated,ratioSpeed, car_nr);
%                 U_o = U_o + U_ot;
%             end
%             fprintf(2, 'POTENTIAL INTEGRAL = [%d] \n', U_o);
%             
%             if U_o > 50000000000
%                 FLAG_LANECHANGE = 0;
%             end
...
%             mycar    = update_mycar(mycar, sim, othercars);
            ...
            if FLAG_LANECHANGE ==1 && mycar.pos(2) > -1700 % added by yanagihara
              othercars  = update_othercars_intelligent_potential(mycar, othercars, sim, track, car_nr); %added by yanagihara
